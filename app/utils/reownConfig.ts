...
// metadata.url and as the shape reference for
...
// value, as "no real project id configured" -- degrade gracefully rather
// than requiring a real id.
...
// every local/dev/preview origin. window.location
